(function (app) {
    ...
    /* =====================================================
       ...
       이전 채팅 조회 결과와 WebSocket 메시지가 겹쳐도
       같은 메시지는 한 번만 출력합니다.
    ===================================================== */
    ...
    function createChatMessageElement(
        ...
        */
        ...
        /*
        화면에는 senderNum이 아니라 senderName을 표시합니다.
        */
        const senderElement =
            document.createElement(
                "strong"
    ...
    function createReadStatusElement(
        message,
        mine
    ) {
        /*
        내가 보낸 메시지에서만 읽음 상태를 표시합니다.
        */
        if (!mine) {
            return null;
        }
        ...
        */
        ...
        statusElement.style.marginRight =
            "6px";
